...
export default function WeatherView({ initialData, initialForecast, city }) {
  ...
  return (
    <div className="min-h-screen relative font-sans text-white">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 py-6 sm:py-8 pb-20">
        {/* ================= HEADER ================= */}
        <motion.div
        ...
        >
          ...
          <LiquidGlassCard className="w-full md:w-96 rounded-2xl">
            <form
              onSubmit={onSearch}
              className="flex items-center px-4 py-2 hover:bg-white/5 transition-colors focus-within:bg-white/10 rounded-2xl"
            >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          >
            <LiquidGlassCard className="h-full rounded-3xl overflow-hidden shadow-2xl">
              <div className="p-8 flex flex-col h-full bg-linear-to-br from-white/10 to-transparent">
                <div className="flex items-center gap-3 text-white/90 mb-4">
                  <MapPin className="w-6 h-6 shrink-0 text-red-400" />
                  <h2 className="text-2xl sm:text-3xl font-bold tracking-tight wrap-break-word line-clamp-2">
                    {current.name}
                  </h2>
                </div>
                ...
                <div className="flex items-center justify-between mt-2 flex-wrap gap-2">
                  ...
                  <img
                    ...
                    className="w-24 h-24 sm:w-28 sm:h-28 drop-shadow-xl sm:scale-125"
          ...
          <div className="lg:col-span-2 flex flex-col gap-8">
              ...
              <LiquidGlassCard className="rounded-3xl p-6">
                <div className="flex flex-row overflow-x-auto gap-4 custom-scrollbar pb-2">
                  {forecast.slice(0, 8).map((item, i) => (
                    <div
                      key={i}
                      className="shrink-0 w-24 flex flex-col items-center justify-between p-3 rounded-2xl bg-white/5 border border-white/10 hover:bg-white/10 transition-colors"
                    >
            ...
            >
              <h3 className="text-lg font-semibold tracking-wide text-white/90 mb-4">
                5-Day Forecast
              </h3>
                ...
                <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                  {forecast
                    ...
                    .map((day, i) => (
                      <div
                        key={i}
                        className="flex flex-col items-center p-4 rounded-xl bg-white/5 border border-white/5 hover:bg-white/10 hover:shadow-lg transition-all"
                      >
